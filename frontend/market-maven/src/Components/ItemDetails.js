            ...
            <div class="flex flex-col md:flex-row -mx-4">
                <div class="md:flex-1 px-4">
                    <div class="h-[460px] rounded-lg bg-gray-200 dark:bg-gray-200 mb-4">
                        <img class="w-full h-full object-cover" src={item.image} alt={item.productTitle}/>
                    </div>
                    <div class="flex -mx-2 mb-4">
                        <div class="w-full px-2">
                            <button class="w-full bg-gray-900 dark:bg-gray-500 text-white py-2 px-4 rounded-full font-bold hover:bg-gray-500 dark:hover:bg-gray-700">Add to Cart</button>
                        </div>
                    </div>
                </div>
                <div class="md:flex-1 px-4">
